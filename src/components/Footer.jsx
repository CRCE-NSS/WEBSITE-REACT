        ...
        <section className="footer">
            <div className="box-container">
                ...
                <div className="box" id="contact">
                    ...
                    <a href="#" className="links">
                        <i className="fa fa-phone"></i>+91 99204 14062 Ratan Singh(President)</a
                    >
                    <a href="#" className="links">
                    ...
                    <a href="mailto:crce.nss@gmail.com" className="links lower">
                        <i className="fa-solid fa-envelope"></i>crce.nss@gmail.com</a
                    >
                    <a
                        ...
                        className="links"
                    >
                        <i className="fa fa-map-marker"></i>Fr. Conceicao Rodrigues College of
            ...
            <div className="footer-end">
                <div className="copyright-and-designers">
                    ...
                    <p id="last-updated">Last Updated: 26 Oct 2023</p>
                </div>
